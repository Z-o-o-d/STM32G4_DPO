...
RGBColor rainbow_colors[10] = {
    {255, 0, 0},  {255, 115, 0}, {255, 201, 0}, {229, 242, 0},  {51, 153, 0},
    {0, 64, 127}, {14, 0, 230},  {67, 0, 142},  {172, 77, 194}, {243, 91, 166}};

FEAnalogStates FEAnalog = {.AC_DC_CH1 = GPIO_PIN_RESET,
                           .AC_DC_CH2 = GPIO_PIN_RESET,
                           .CD_CH1 = 0,
                           .CD_CH2 = 0,
                           .OFFSET1 = 2200,
                           .OFFSET2 = 2200};
...
void DDS_Onboard_Update(void) {
  ...
  __HAL_HRTIM_SETCOMPARE(&hhrtim1, HRTIM_TIMERINDEX_TIMER_C,
                         HRTIM_COMPAREUNIT_1, DDS_Onboard_COMPAREUNIT);
}
...
int main(void) {
  ...
  HAL_HRTIM_WaveformCounterStart(
      &hhrtim1, HRTIM_TIMERID_TIMER_C); // Start the counter of the Timer A
